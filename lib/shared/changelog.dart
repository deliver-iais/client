const List<String> FARSI_FEATURE_LIST = [
  ...
  'اضافه کردن قابلیت ضبط ویدیو در خود کلاینت‌های موبایلی',
  'اضافه شدن تنظیمات بیشتر برای اندازه فونت، کشیدگی متن، پخش صدا ارسال و دریافت پیام در هنگام چت',
  ...
  'و رفع برخی باگ‌های گزارش شده‌ی دیگر',
];
...
const List<String> ENGLISH_FEATURE_LIST = [
  ...
  'Add recording video feature in mobile apps',
  'Add more settings for font size, justification and in-chat sounds',
  ...
  'And many reported bugs fixed...',
];

const List<String> ARABIC_FEATURE_LIST = [
  'اضافه کردن قابلیت انتخاب میکروفن در دسکتاپ برای تماس صوتی و تصویری',
  'بهبود نمایش نوتیفیکیشن‌های برنامه در اندروید و مک',
  'اضافه کردن قابلیت ضبط ویدیو در خود کلاینت‌های موبایلی',
  'اضافه شدن تنظیمات بیشتر برای اندازه فونت، کشیدگی متن، پخش صدا ارسال و دریافت پیام در هنگام چت',
