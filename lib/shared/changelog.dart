...
const List<String> FARSI_FEATURE_LIST = [
  ...
  'رفع باگ نمایش mention در چت‌ها و سینک نبودن آن',
  'نمایش روز در هنگام اسکرول',
  'نمایش پیش نمایش تصاویر قبل از دانلود تصاویر',
...
const List<String> ENGLISH_FEATURE_LIST = [
  ...
  'Bug fix in showing mention',
  'Showing date when scrolling',
  'Adding Thumbnail before loading',
