...
const SHARED_DAO_THEME_SHOW_COLORFUL_MESSAGES =
    "SHARED_DAO_THEME_SHOW_COLORFUL";
const SHARED_DAO_THEME_SHOW_TEXTS_JUSTIFIED =
    "SHARED_DAO_THEME_SHOW_TEXTS_JUSTIFIED";
const SHARED_DAO_THEME_SHOW_LINK_PREVIEW = "SHARED_DAO_THEME_SHOW_LINK_PREVIEW";
const SHARED_DAO_THEME_PLAY_IN_CHAT_SOUNDS =
    "SHARED_DAO_THEME_PLAY_IN_CHAT_SOUNDS";
const SHARED_DAO_THEME_PATTERN = "SHARED_DAO_THEME_PATTERN";
const SHARED_DAO_THEME_FONT_SIZE = "SHARED_DAO_THEME_FONT_SIZE";
...
const SHARED_DAO_LAST_MESSAGE_DELIVERY_ACK =
    "SHARED_DAO_LAST_MESSAGE_DELIVERY_ACK";
const SHARED_DAO_LAST_CALL_DATA_SLOT_1 = "LAST_CALL_DATA_SLOT_1";
const SHARED_DAO_LAST_CALL_DATA_SLOT_2 = "LAST_CALL_DATA_SLOT_2";
const SHARED_DAO_LAST_CALL_DATA_SLOT_3 = "LAST_CALL_DATA_SLOT_3";
