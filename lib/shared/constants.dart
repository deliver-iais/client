...
const LB_ADDRESS = "lb.yechat.org";
...
enum SharedKeys {
  ...
  SHARED_DAO_ACCESS_TOKEN_TIME_KEY,
  SHARED_DAO_ACCESS_TOKEN_TIME_EXP_KEY,
  SHARED_DAO_REFRESH_TOKEN_KEY,
  SHARED_DAO_REFRESH_TOKEN_TIME_KEY,
  SHARED_DAO_REFRESH_TOKEN_TIME_EXP_KEY,
  ...
  SHARED_DAO_IN_LOCAL_NETWORK,
  SHARED_DAO_USE_DEFAULT_UDP_ADDRESS,
...
const LOCCAL_NETWORK_CONNECTIONS_TRACK_ID = 46;
const SERVERLESS_REQUEST_TRACK_ID = 47;
...
// UI
const double APPBAR_HEIGHT = 43.0;
