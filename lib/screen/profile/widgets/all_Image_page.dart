  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<int?>(
          future: _mediaDao.getIndexOfMedia(widget.roomUid, widget.messageId),
          builder: (context, snapshot) {
            if (snapshot.hasData && snapshot.data != null) {
              _currentIndex.add(snapshot.data!);
              return Stack(
                children: [
                  Row(
                                      ...
                                      return FutureBuilder<Media?>(
                                        ...
                                        builder: (c, mediaSnapShot) {
                                          if (mediaSnapShot.hasData &&
                                            ...
                                            return Hero(
                                              tag: jsonDecode(mediaSnapShot
                                                  .data!.json)["uuid"],
                                              child: FutureBuilder<String?>(
                                                  initialData:
                                                      _fileCache.get(index),
                      ...
                      if (isDesktop())
                        StreamBuilder<int?>(
                            ...
                            builder: (c, allImageCount) {
                              if (allImageCount.hasData &&
                                  allImageCount.data != null) {
